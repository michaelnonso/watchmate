...
SECRET_KEY = 'django-insecure-d-w5tgh94km&&reyhoq5bj@-u+#vjjvvyzyktxf%8@6@-*d+p4'
...
# #authentication needs to be provided for use in each and every view class
# REST_FRAMEWORK = {
